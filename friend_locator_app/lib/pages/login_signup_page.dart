...
class _LoginSignupPageState extends State<LoginSignupPage> {
  ...
  // Check whether the form is valid before login or signup
    ...
    return new Hero(
      ...
      child: Padding(
        ...
        child: CircleAvatar(
          ...
          radius: 100.0,
          child: Image.asset('assets/friend_locator_image.png'),
        ),
      ),
    );
  }
        ...
        child: SizedBox(
          ...
          child: new RaisedButton(
            ...
            child: new Text(_isLoginForm ? 'Login' : 'Create account',
                style: new TextStyle(fontSize: 23.0, color: Colors.white)),
